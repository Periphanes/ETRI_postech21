...
parser.add_argument('--input-types', type=str, default="static", choices=["static", "txt", "audio", "sig", "audio_txt", "audio_txt_shortform", "txt_shortform"])
...
parser.add_argument('--bottleneck-length', type=int, default=3)
